...
??? note "Answer"
    ...
    3. $\sum\limits_{i=1}^{9}(\frac{X_i - \overline{X}}{\sigma})^2 \sim \chi^2(8)$

    4. $\sum\limits_{i=1}^{9}(\frac{X_i - \mu}{\sigma})^2 \sim \chi^2(9)$

    5. 记 $Z = \frac{3(\overline{X} - \mu)}{\sigma} \sim N(0,1)$
